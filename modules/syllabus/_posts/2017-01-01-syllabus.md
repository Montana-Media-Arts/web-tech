...
- [Web Technologies, MART 441 --- Main Website](https://montana-media-arts.github.io/web-tech/)
- [Course GitHub Repo](https://github.com/Montana-Media-Arts/441-WebTech) (This git repository holds code examples, and the issues board.)
- [Direct Link to Course Moodle Shell](https://moodle.umt.edu/course/view.php?id=20156)
- [Syllabus Link](https://montana-media-arts.github.io/web-tech/syllabus)
...
- <cite>Haverbeke, Marijn. Eloquent JavaScript: A Modern Introduction to Programming. N.p., 2011. Web.</cite>
    - It is available as a digital online copy (i.e., free), or purchased paper back through the following link;
